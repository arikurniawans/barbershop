							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Rekapitulasi Transaksi Produk Barbershop</h2>
										<p>Hasil rekapitulasi transaksi produk barbershop</p>
									</div>
								</div>
							</div>

                            <div class="pull-right">
								<form class="form-inline" action="<?php echo base_url(); ?>laporan/rekapproduk" method="post">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <div class="pull-right">
								<form class="form-inline" action="<?php echo base_url(); ?>laporan/cetakproduk" method="post" target="_blank">
                            ...
                            <h2>Tabel Data Rekapitulasi Transaksi Produk</h2>
                        </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "Rp.".number_format($data->tarif_produk,0,",","."); ?></td>
                                        <td><?php echo $data->qty; ?> (item)</td>
